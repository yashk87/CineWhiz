...
import { Badge, Chip, Divider, Paper, Tooltip } from "@mui/material";
        ...
        {token
          ? [
              ...
              <MenuItem className="h-max !border !border-gray-700 !w-[230px] !pt-8 !pb-2 flex-col flex items-center justify-center !p-0  !bg-gray-100 !z-0">
                ...
                {/* <div className="flex mt-4 w-full mb-2 items-center gap-1 justify-center flex-wrap ">
                  {user?.profile.map((item, id) => (
                    <Chip
                      key={id}
