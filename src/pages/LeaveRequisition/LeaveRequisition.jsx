...
const LeaveRequisition = () => {
  ...
  // const totalVactions = vactionList.reduce(
  //   (acc, vacation) => acc + vacation.count,
  //   0
  // );
  ...
  return (
    <>
      ...
      <div className="flex w-full bg-gray-50 min-h-screen justify-center py-10 px-6 gap-4">
        <article className="w-[40%] h-max py-6 px-8 bg-white shadow-lg rounded-lg ">
            ...
            item.count <= 0 ? (
              <div className="mt-6 text-red-700">
                <div className="text-red-700 flex gap-2 items-center">
                  <ErrorIcon />
                  <h1 className="text-lg font-semibold">{item.leaveName}</h1>
                </div>
              ...
              <div className="mt-6" key={index}>
                <h1 className="text-lg font-semibold">{item.leaveName}</h1>
                <h1 className="text-md mb-4">{item.count} leaves left</h1>
                <Divider variant="fullWidth" orientation="horizontal" />
              </div>
            )
          )}
          ...
          {value.length > 0 && (
            <>
              <div className="h-max !mt-4 space-y-2 bg-white py-3 px-8 shadow-lg rounded-lg">
                <h1 className="font-semibold mb-4 text-md">Leave time</h1>
                    ...
                    >
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <p className="text-md">Ending date: {item.endDate}</p>
                        </div>
                      </div>
                    </div>
