            ...
            <div className="md:w-[50%] w-[100%]  md:px-8  xs:px-2 flex justify-end items-end  flex-col">
              <div>
                ...
                <p className="md:text-xl xs:text-md mb-8 text-gray-600 md:leading-10 xs:leading-5 ">
                  ...
                  <span className="!text-bold gradinet">AGIES</span>, Lets start
                </p>
                ...
                {isLoading ? (
                  ...
                  <Link to={"/add-organisation"}>
                    <button className=" flex justify-center  gap-2 items-center rounded-md px-4 py-3 text-md font-semibold text-white bg-blue-500 hover:bg-blue-500 focus-visible:outline-blue-500">
                      Create your organization <FaArrowCircleRight />
                    </button>
                  </Link>
                ) : (
                  <Link to={"/organizationList"}>
                    <button className=" flex justify-center gap-2 items-center rounded-md px-4 py-3 text-md font-semibold text-white bg-blue-500 hover:bg-blue-500 focus-visible:outline-blue-500">
                      Go to Organization <FaArrowCircleRight />
                    </button>
                  </Link>
                )}
              </div>
