...
const EmployeeList = () => {
  ...
  const filteredEmployees = availableEmployee.filter((item) => {
    return (
      (!nameSearch.toLowerCase() ||
        (item.first_name &&
          item.first_name.toLowerCase().includes(nameSearch))) &&
      (!deptSearch.toLowerCase() ||
        (item.deptname && item.deptname.toLowerCase().includes(deptSearch))) &&
...
//   const npage = Math.ceil(availableEmployee.length / recordPerPage);
